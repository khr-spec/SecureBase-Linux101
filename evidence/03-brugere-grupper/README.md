...
| [3.2](figur-3-02.png) | Rollegrupperne admins, developers og guests er oprettet med GID 1004, 1005 og 1006. Udsnit af terminalbilledet. |
...
| [3.9](figur-3-09.png) | Gæsten læser begge linjer. Skrivning til rolletest.txt og oprettelse af guest-test.txt afvises. Den afsluttende læsning viser uændret indhold. Udsnit af terminalbilledet. |
